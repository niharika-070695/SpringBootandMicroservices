...
//		controller.createNewCustomer(customer);
		...
		Customer customer1 = new Customer(102,"Dhoni","Kansas","dhoni@google.com","8878676545");
//		CustomerServiceImpl csi = context.getBean(CustomerServiceImpl.class);
//		csi.createNewBrandCustomer(customer);
		
		Customer customer2 = new Customer(103,"Karthik","Denver","karthik@deloitte.com","9954453245");
		Customer customer3 = new Customer(104,"Mahesh","StLouis","mahesh@deloitte.com","9954453245");
		Customer customer4 = new Customer(105,"Kristina","Denver","kristina@deloitte.com","4254621245");
		Customer customer5 = new Customer(106,"Angela","Omaha","angela@deloitte.com","6754478945");
		Customer customer6 = new Customer(107,"Christina","Tennesse","chris@deloitte.com","5698478921");
//		
		CustomerController controller = context.getBean(CustomerController.class);
		controller.createNewCustomers(List.of(customer,customer1,customer2,customer3,customer4,customer5,customer6));
